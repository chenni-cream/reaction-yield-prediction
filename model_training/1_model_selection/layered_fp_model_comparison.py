...
def main() -> None:
    ...
    output_root = script_dir.parent / "ckpt-baseline-comparison"
    ...
    all_fold_df.to_csv(results_dir / "all_models_fold_metrics.csv", index=False)
    all_summary_df.to_csv(results_dir / "all_models_summary_metrics.csv", index=False)
