...
MODEL_ROOT = SCRIPT_DIR.parent / "ckpt-baseline-comparison" / "LightGBM"
...
def main() -> None:
    ...
    if all_results:
        ...
        if all_global_trues:
            ...
            print(f"\n  >> 全局 pooled R2 (round1+round2): {global_r2:.6f}")

        # 保存结果
        out_path = SCRIPT_DIR.parent / "results" / "test_generalization_results.csv"
